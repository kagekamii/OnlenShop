          ...
          <div class="container">
            ...
            <form action="/home/login" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="maks. 191 karakter" name="username" autofocus required>
              </div>

              <div class="form-group">
                <label for="pwd">Password:</label>
                <input type="password" class="form-control" placeholder="maks. 191 karakter" name="password"
                  required>
              </div>
